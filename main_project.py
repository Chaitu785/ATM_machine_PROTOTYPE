...
class welcomeScreen:
    def __init__(self, window=None):
        ...
        window.title("Welcome to Bank of India")
        p1 = PhotoImage(file='./images/bank1.png')
        window.iconphoto(True, p1)
        window.configure(background="#c0e9fd")
        window.configure(cursor="arrow")

        self.Canvas1 = tk.Canvas(window, background="#07a4f3", borderwidth="0", insertbackground="black",
                                 relief="ridge",
        ...
        self.Label1 = tk.Label(self.Canvas1, background="#87d5fc", disabledforeground="#a3a3a3",
...
class adminLogin:
    def __init__(self, window=None):
        ...
        window.resizable(0, 0)
        window.title("Admin")
        window.configure(background="#07a4f3")
        ...
        self.Label1 = tk.Label(Canvas1, background="blue", disabledforeground="#a3a3a3",
        ...
        self.Button = tk.Button(Canvas1, text="Login", borderwidth="0", width=10, background="green",
                                foreground="#00254a",
